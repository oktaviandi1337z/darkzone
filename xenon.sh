...
echo
echo $pur"==================="$cy" ==================="
echo $i""$pu"  AUTHOR  :  Okta Viandy  "$i"                   "
echo $i""$pu"  WhatsApp:  0831797xxxx"$i"                "
echo $i""$pu"  GMAIL   :  xenon1337z@linux.mail.org"$i"    "
echo $i""$pu"  YOUTUBE :  DarkNet"$i"                "
echo $pur"==================="$cy" ==================="
echo
...
sleep 2
echo $ku"Facebook :"$i" Okta Viandy"
echo $ku"YouTube  :"$i" DarkNet"
echo $ku"WhatsApp :"$i" 0831797xxxx"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { YOUTUBE DarkNet }"
exit
fi
